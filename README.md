- [boutique_ado demo project](#boutique-ado-demo-project)
...
- [Base Templates](#base-templates)
  ...
  * [Also need CSS to format page](#also-need-css-to-format-page)
    + [Base.css as used by CI for Boutique_Ado :](#basecss-as-used-by-ci-for-boutique-ado--)
...
- [members](#members)
  * [fixtures/members.json](#fixtures-membersjson)
  * [Loading member json fixture](#loading-member-json-fixture)
  * [Fixtures](#fixtures)
  ...
  * [Context Processors](#context-processors)
    ...
    + [Form to add items within product detail template.](#form-to-add-items-within-product-detail-template)
    + [bag/add_to_bag in views.html](#bag-add-to-bag-in-viewshtml)
    + [create a url for the view's 'add_to_bag'](#create-a-url-for-the-view-s--add-to-bag-)
    + [product_detail form](#product-detail-form)
    + [update custom context processor](#update-custom-context-processor)
    + [bag/bag.html](#bag-baghtml)
  * [Shell command](#shell-command)
  * [Bootstrap Toasts](#bootstrap-toasts)
    + [Django messages (import django.contrib.messages) have levels.](#django-messages--import-djangocontribmessages--have-levels)
    + [In templates/base.html need to plug these toast messages in.](#in-templates-basehtml-need-to-plug-these-toast-messages-in)
    + [Styling the toasts within base.css.](#styling-the-toasts-within-basecss)
    + [settings.py:](#settingspy-)
    + [bag/views.py:](#bag-viewspy-)
  * [checkout app and STRIPE](#checkout-app-and-stripe)
    + [models](#models)
    + [checkout/admin.py](#checkout-adminpy)
    + [signals](#signals)
    + [checkout form](#checkout-form)
    + [checkout view](#checkout-view)
- [STRIPE payments](#stripe-payments)
    + [STRIPE Elements](#stripe-elements)
    + [install the libraries for access to the Stripe API from your application:](#install-the-libraries-for-access-to-the-stripe-api-from-your-application-)
    + [add a checkout button:](#add-a-checkout-button-)
    + [Add an event handler to the checkout button](#add-an-event-handler-to-the-checkout-button)
    + [Add the Stripe.js library to your page:](#add-the-stripejs-library-to-your-page-)
    + [Redirect customer to STRIPE checkout:](#redirect-customer-to-stripe-checkout-)
  * [STRIPE payements redundancy](#stripe-payements-redundancy)
    + [STRIPE webhooks](#stripe-webhooks)
    + [checkout/webhook_handler.py](#checkout-webhook-handlerpy)
    + [Set up with checkout/urls.py:](#set-up-with-checkout-urlspy-)
    + [checkout/webhooks.py](#checkout-webhookspy)
    + [settings.py:](#settingspy--1)
  * [Problem with asynchronous control.](#problem-with-asynchronous-control)
- [Profiles](#profiles)
